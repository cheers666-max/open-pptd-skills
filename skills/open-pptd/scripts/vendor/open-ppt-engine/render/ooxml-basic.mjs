import { encodeEotFont } from "./eot-font.mjs";
...
function chartAxesXml(categoryAxisId, valueAxisId, style = {}) {
  ...
  return `<c:catAx><c:axId val="${categoryAxisId}"/>${axisScalingXml(xAxis)}<c:delete val="0"/><c:axPos val="b"/>${axisGridlinesXml(xAxis, false, xStyle)}${axisTitleXml(xAxis.title, { ...xStyle, axisTitleColor: xAxis.titleColor, axisTitleFontSize: xAxis.titleFontSize })}${axisNumberFormatXml(xAxis)}<c:majorTickMark val="out"/><c:minorTickMark val="none"/><c:tickLblPos val="nextTo"/>${chartAxisLineXml(xAxis.lineColor ?? chartStyle.axisColor, xAxis.lineWidth ?? 1)}${chartTextPropertiesXml(xStyle, xAxis.fontSize ?? chartStyle.axisFontSize)}<c:crossAx val="${valueAxisId}"/><c:crosses val="autoZero"/><c:auto val="1"/><c:lblAlgn val="ctr"/><c:noMultiLvlLbl val="1"/></c:catAx><c:valAx><c:axId val="${valueAxisId}"/>${axisScalingXml(yAxis)}<c:delete val="0"/><c:axPos val="l"/>${axisGridlinesXml(yAxis, true, yStyle)}${axisTitleXml(yAxis.title, { ...yStyle, axisTitleColor: yAxis.titleColor, axisTitleFontSize: yAxis.titleFontSize })}${axisNumberFormatXml(yAxis)}<c:majorTickMark val="out"/><c:minorTickMark val="none"/><c:tickLblPos val="nextTo"/>${chartAxisLineXml(yAxis.lineColor ?? chartStyle.axisColor, yAxis.lineWidth ?? 1)}${chartTextPropertiesXml(yStyle, yAxis.fontSize ?? chartStyle.axisFontSize)}<c:crossAx val="${categoryAxisId}"/><c:crosses val="autoZero"/><c:crossBetween val="between"/>${axisMajorUnitXml(yAxis)}</c:valAx>`;
}
...
function scatterAxesXml(xAxisId, yAxisId, style = {}) {
  ...
  const xStyle = { ...chartStyle, textColor: xAxis.labelColor ?? chartStyle.textColor, fontFamily: xAxis.fontFamily ?? chartStyle.fontFamily };
  const yStyle = { ...chartStyle, textColor: yAxis.labelColor ?? chartStyle.textColor, fontFamily: yAxis.fontFamily ?? chartStyle.fontFamily };
  return `<c:valAx><c:axId val="${xAxisId}"/>${axisScalingXml(xAxis)}<c:delete val="0"/><c:axPos val="b"/>${axisGridlinesXml(xAxis, true, xStyle)}${axisTitleXml(xAxis.title, { ...xStyle, axisTitleColor: xAxis.titleColor, axisTitleFontSize: xAxis.titleFontSize })}${axisNumberFormatXml(xAxis)}<c:majorTickMark val="out"/><c:minorTickMark val="none"/><c:tickLblPos val="nextTo"/>${chartAxisLineXml(xAxis.lineColor ?? chartStyle.axisColor, xAxis.lineWidth ?? 1)}${chartTextPropertiesXml(xStyle, xAxis.fontSize ?? chartStyle.axisFontSize)}<c:crossAx val="${yAxisId}"/><c:crosses val="autoZero"/><c:crossBetween val="midCat"/>${axisMajorUnitXml(xAxis)}</c:valAx><c:valAx><c:axId val="${yAxisId}"/>${axisScalingXml(yAxis)}<c:delete val="0"/><c:axPos val="l"/>${axisGridlinesXml(yAxis, true, yStyle)}${axisTitleXml(yAxis.title, { ...yStyle, axisTitleColor: yAxis.titleColor, axisTitleFontSize: yAxis.titleFontSize })}${axisNumberFormatXml(yAxis)}<c:majorTickMark val="out"/><c:minorTickMark val="none"/><c:tickLblPos val="nextTo"/>${chartAxisLineXml(yAxis.lineColor ?? chartStyle.axisColor, yAxis.lineWidth ?? 1)}${chartTextPropertiesXml(yStyle, yAxis.fontSize ?? chartStyle.axisFontSize)}<c:crossAx val="${xAxisId}"/><c:crosses val="autoZero"/><c:crossBetween val="midCat"/>${axisMajorUnitXml(yAxis)}</c:valAx>`;
}
...
const contentTypes = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types"><Default Extension="rels" ContentType="application/vnd.openxmlformats-package.relationships+xml"/><Default Extension="xml" ContentType="application/xml"/><Default Extension="png" ContentType="image/png"/><Default Extension="jpg" ContentType="image/jpeg"/><Default Extension="jpeg" ContentType="image/jpeg"/><Default Extension="gif" ContentType="image/gif"/><Default Extension="webp" ContentType="image/webp"/><Default Extension="svg" ContentType="image/svg+xml"/><Default Extension="fntdata" ContentType="application/x-fontdata"/><Override PartName="/ppt/presentation.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.presentation.main+xml"/><Override PartName="/ppt/presProps.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.presProps+xml"/><Override PartName="/ppt/viewProps.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.viewProps+xml"/><Override PartName="/ppt/tableStyles.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.tableStyles+xml"/><Override PartName="/ppt/slideMasters/slideMaster1.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.slideMaster+xml"/><Override PartName="/ppt/slideLayouts/slideLayout1.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"/><Override PartName="/ppt/theme/theme1.xml" ContentType="application/vnd.openxmlformats-officedocument.theme+xml"/><Override PartName="/ppt/theme/theme2.xml" ContentType="application/vnd.openxmlformats-officedocument.theme+xml"/><Override PartName="/docProps/core.xml" ContentType="application/vnd.openxmlformats-package.core-properties+xml"/><Override PartName="/docProps/app.xml" ContentType="application/vnd.openxmlformats-officedocument.extended-properties+xml"/>`;
...
const notesMasterRels = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme" Target="../theme/theme2.xml"/></Relationships>`;
...
function buildThemeXml(theme = {}) {
  ...
  const body = escapeXml(fonts.body ?? "Aptos");
  const cjk = escapeXml(fonts.cjk ?? fonts.fallbacks?.cjk?.[0] ?? body);
  return `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><a:theme xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" name="Open PPT"><a:themeElements><a:clrScheme name="Open"><a:dk1><a:sysClr val="windowText" lastClr="${color("ink", "#1E1E1E")}"/></a:dk1><a:lt1><a:sysClr val="window" lastClr="${color("white", "#FFFFFF")}"/></a:lt1><a:dk2><a:srgbClr val="${color("ink", "#1E1E1E")}"/></a:dk2><a:lt2><a:srgbClr val="${color("paper", "#F7F5F0")}"/></a:lt2><a:accent1><a:srgbClr val="${color("accent", "#B32635")}"/></a:accent1><a:accent2><a:srgbClr val="${color("slate", "#2A2B2E")}"/></a:accent2><a:accent3><a:srgbClr val="${color("line", "#D3CEC3")}"/></a:accent3><a:accent4><a:srgbClr val="${color("white", "#FFFFFF")}"/></a:accent4><a:accent5><a:srgbClr val="${color("muted", "#6E6B65")}"/></a:accent5><a:accent6><a:srgbClr val="${color("accentDark", "#8E1B27")}"/></a:accent6><a:hlink><a:srgbClr val="0563C1"/></a:hlink><a:folHlink><a:srgbClr val="954F72"/></a:folHlink></a:clrScheme><a:fontScheme name="Open"><a:majorFont><a:latin typeface="${heading}"/><a:ea typeface="${cjk}"/><a:cs typeface="${heading}"/></a:majorFont><a:minorFont><a:latin typeface="${body}"/><a:ea typeface="${cjk}"/><a:cs typeface="${body}"/></a:minorFont></a:fontScheme>${themeFormatSchemeXml}</a:themeElements><a:objectDefaults/><a:extraClrSchemeLst/></a:theme>`;
}
...
export async function exportOoxmlBasic(deck, outputPath, {
  ...
  for (const font of embeddedFonts) writePart(`ppt/fonts/${font.fileName}`, encodeEotFont(font.bytes));
  ...
  // PowerPoint repairs files when slide and notes masters share one theme part.
  writePart("ppt/theme/theme2.xml", buildThemeXml(resolvedDeck.theme));
